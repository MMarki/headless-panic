...
Game.EntityRepository.define('bat', {
    ...
    accuracyValue: 50,
    speed: 1000,
    description: "Flies quickly and won't attack unless you bother it.",
...
Game.EntityRepository.define('goblin', {
    ...
    sightRadius: 10,
    headHits: 2,
    description: "An armored underdweller with bulging eyes.",
    headPower: 'ARMR +1',
    tasks: ['hunt', 'wander'],
    mixins: [Game.EntityMixins.TaskActor, Game.EntityMixins.Sight,
             Game.EntityMixins.Attacker, Game.EntityMixins.Destructible,
...
Game.EntityRepository.define('mushroom man', {
    ...
    description: "A humanoid hulk of fungus with no discernible head.",
    tasks: ['hunt', 'wander'],
    mixins: [Game.EntityMixins.TaskActor, Game.EntityMixins.Sight,
             Game.EntityMixins.Attacker, Game.EntityMixins.Destructible,
...
Game.EntityRepository.define('toad queen', {
    ...
    explodeSize: 14,
    description: "An ox-sized, bloated toad.",
    summonWaitMax: 30,
    summonCount: 1,
    summonName: 'toadman',
    tasks: ['summonMonster', 'hopHunt', 'hopWander'],
    headPower: 'ARMR +1 on water tiles',
    mixins: [Game.EntityMixins.TaskActor, Game.EntityMixins.Sight,
             Game.EntityMixins.Attacker, Game.EntityMixins.Destructible,
             Game.EntityMixins.HeadDropper, Game.EntityMixins.Affectible,
...
Game.EntityRepository.define('golem', {
    ...
    resistances: ['stab'],
    speed: 500,
    description: "A lumbering rock monster.",
    tasks: ['hunt', 'wander'],
